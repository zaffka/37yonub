...
Сразу оговорюсь - код буду сильно упрощать и урезать, чтобы не лишать вас удовольствия самостоятельных экспериментов и поиска косяков :))
...
Поскольку тестируемая функция exist() имеет областью видимости пакет main, то и наш тест будет частью этого пакета.
