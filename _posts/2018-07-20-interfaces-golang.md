...
Чтобы показать глубину задумки авторов языка, хочу ещё привести наглядный пример, что есть интерфейс и как он нам облегчает жизнь. В частности для создания структур-заглушек (mock-объектов).
